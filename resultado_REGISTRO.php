...
/**
 * Verifica que los datos recibidos por $_REQUEST son validos
 * @return bool True si son validos, False en caso contrario
 */
    ...
    <body>
        ...
        <?php
            ...
            if (count ($errores)==0) {
                ...
                echo $error.'<br>';
                echo "<a href='javascript:history.go(-1);'>Volver al formulario de Registro<a href/>";
                }
            }
        ?>
    </body>
